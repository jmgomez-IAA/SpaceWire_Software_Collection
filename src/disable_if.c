/*
  ...
  @brief Demostration RMAP packet to disable the GR718  if.
  @details Demostrates how to disable a GR718B IF using RMAP packets. The   
...
int __cdecl main(int argc, char *argv[]){
  ...
  status = RMAP_FillWriteCommandPacket(pTarget, 2, pReply, 1, 1, 0, 0, 0x00,
				       0, 0x800, 0, pData, 4, &fillPacketLen, NULL, 1, (U8 *)pFillPacket,
				       fillPacketLenCalculated);
  if (!status)
    {
